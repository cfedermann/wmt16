...
# Write .all.csv file combining data for all language pairs
writers[(None,None)] = csv.DictWriter(open('%s.all.csv' % (csvPrefix,), 'w'), fieldnames=header_fields)
writers[(None,None)].writeheader()
    ...
    for ranking in rankings:
        for result in ranking.findall(".//ranking-result"):
            ...
            for element in itertools.combinations(systems_ranks, 2):
                ...
                writers[(None, None)].writerow(csv_row)
